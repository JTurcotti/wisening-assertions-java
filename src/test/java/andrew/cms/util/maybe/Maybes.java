...
class Maybes {
    ...
    private static final class None<T> extends Maybe<T> {
        ...
        /* commented out due to spoon bug
        @Override
    ...
    static <T> Maybe<T> none() { return Maybes.theNone; }
    ...
    static <T> Maybe<T> some(T v) {
        if (v == null) {
            throw new Error("Maybe.some() requires a non-null argument");
        }
