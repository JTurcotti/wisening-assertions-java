...
import andrew.a5.ai.GameModel;
import andrew.a5.ai.PenteModel;
import andrew.a5.ai.TicTacToeModel;
import andrew.a5.logic.MNKGame;
import andrew.a5.logic.Pente;
import andrew.a5.logic.Position;
import andrew.a5.logic.TicTacToe;
import andrew.a5.ui.AIPlayer;
import andrew.a5.ui.HumanPlayer;
import andrew.a5.ui.Player;
import andrew.a5.util.GameResult;
import andrew.a5.util.GameType;
import andrew.a5.util.PlayerRole;
import andrew.a5.util.PlayerType;
...
public class Main {
    ...
    private static void showUsage() {
        String sb = "usage: andrew.a5.Main [--help] [--showinfo] [--timelimit <ms>]" +
                " " + GameType.options() +
                " " + PlayerType.options() +
                " " + PlayerType.options();
